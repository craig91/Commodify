...
var NavSmall = React.createClass({
  render: function () {
    return (
      <div id="navcontainer" className="container-fluid nav-container tiny">
        <nav id="navHeader" className="navbar navbar-fixed-top" role="navigation">
          <div className="navbar-header">
          <Link className="navbar-brand" to="/"><img src={require('./comodifi-rev.png')} height="25" width="auto" alt="Commodifi Logo Small"/></Link>
